 ...
 * @since 1.7.0
 */
public class DisableWorkflowManagementTest extends AbstractLSTest {
...
//            updateConfig(configJsonPath, updatedConfig);
    ...
    protected String getResourceDir() {
        return "disable_workflow_management";
    }

    @Override
    protected Class<? extends AbstractLSTest> clazz() {
        return DisableWorkflowManagementTest.class;
    }

    @Override
    protected String getApiName() {
        return "disableWorkflowManagement";
    }
    ...
    /**
     * Represents the test configuration for disabling the workflow management REST API.
     *
     * @param projectPath path of the project
     * @param description description of the test
     * @param output      the expected text edits, keyed by file path relative to the source directory
     */
