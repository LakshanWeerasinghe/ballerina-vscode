 ...
 * deeply-nested) {@code TriggerUISchemaModel} just to populate the picker list. A legacy trigger (e.g. Solace,
 ...
 * @param icon        the schema-driven trigger's icon, if any
